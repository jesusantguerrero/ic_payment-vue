    ...
    <ul class="aside-nav">
      <li class="aside-buttons">
        <a href="#company-section">
          <i class="material-icons">description</i> Empresa</a>
      </li>
      <li class="aside-buttons">
        <a href="#user-section">
          <i class="material-icons">person_pin</i> Usuarios</a>
      </li>
      <li class="aside-buttons">
        <a href="#caja-section">
          <i class="material-icons">move_to_inbox</i> Caja Chica</a>
      </li>
      <li class="aside-buttons">
      ...
      <li class="aside-buttons">
        <a href="#message-settings-section">
          <i class="material-icons">phonelink_setup</i> Ajustes de Mensajes</a>
      </li>
    </ul>
  </div>
         ...
         ?>
          ...
          <form action="">
            <div class="company-profile">
              <img src="<?php echo $logo ?>" alt="company_logo" class="company-profile__logo" />
            </div>
            <div class="row">
              <div class="col-md-6">
    ...
    ********************************-->
      ...
      <div class="company-details" id="user-section">
        ...
        <div class="searcher-container main-toolbar" id="user-toolbar">
          ...
          <div class="pull-right">
            <button class="btn btn-primary icon" id="caller-user" data-toggle="modal" data-target="#new-user-modal">Agregar
              <i class="material-icons">add</i>
            </button>
          </div>
        </div>

        <table class="table t-users" id="t-users" data-sort-name="order" data-minimum-count-columns="2" data-show-pagination-switch="false"
          data-search="true" data-toolbar="#user-toolbar" data-pagination="true" data-unique-id="id" data-page-size="5" data-page-list="[5]"
          data-show-footer="false" data-striped="false">
          <thead>
            <tr>
    ...
    ********************************-->
      ...
      <div class="company-details" id="caja-section">
        ...
        <table class="table t-users" id="caja" data-sort-name="order" data-minimum-count-columns="2" data-show-pagination-switch="false"
          data-search="true" data-toolbar="#caja-toolbar" data-pagination="true" data-search="true" data-unique-id="id" data-page-size="5"
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                    <i class="material-icons">&percnt;</i>
                  </div>
