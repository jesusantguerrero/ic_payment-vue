	...
	<script type="text/javascript" src="<?php echo base_url('assets/js/min/final.bundle.js?version=pre-1.0.3')?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/js/min/components.js?version=pre-1.0.3')?>"></script>
	<script>
		$(function(){
