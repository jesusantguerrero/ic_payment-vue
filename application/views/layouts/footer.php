	...
	<script type="text/javascript" src="<?php echo base_url('assets/js/min/mytables.min.js?version=3.27.0') ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/js/min/all.min.js?version=3.27.0')?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/js/min/frontend.min.js?version=3.27.0')?>"></script>
	<script>
		$(function(){
