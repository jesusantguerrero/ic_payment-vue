	...
	<script type="text/javascript" src="<?php echo base_url('assets/js/min/final.bundle.js?version=beta-3.7.4.2')?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/js/min/components.js?version=beta-3.7.4.2')?>"></script>
	<script>
		$(function(){
