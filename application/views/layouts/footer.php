	...
	<script type="text/javascript" src="<?php echo base_url('assets/js/all.js?version=pre-1.0.5')?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/js/min/components.js?version=pre-1.0.5')?>"></script>
	<script>
		$(function(){
