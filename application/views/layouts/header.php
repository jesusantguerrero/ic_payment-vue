...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('assets/css/material-icons.css?version=3.2.2') ?>">
	<link rel="stylesheet" href="<?php echo base_url('assets/css/font-awesome.min.css?version=3.2.2') ?>">
	<link rel="stylesheet" href="<?php echo base_url('assets/css/secundaryCss.min.css?version=3.2.2') ?>" />
	<link rel="stylesheet" href="<?php echo base_url('assets/css/5-others/square/frontend.min.css?version=3.2.2') ?>" />
	<link rel="stylesheet" href="<?php echo base_url('assets/css/main.min.css?version=3.2.2') ?>" />
	<script type="text/javascript" src="<?php echo base_url('assets/js/min/headLibraries.min.js?version=3.2.2') ?>"></script>
