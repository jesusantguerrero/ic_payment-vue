...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('assets/css/secundaryCss.min.css?version=beta-3.5.15') ?>" />
	<link rel="stylesheet" href="<?php echo base_url('assets/css/5-others/square/frontend.min.css?version=beta-3.5.15') ?>"/>
 	<link rel="stylesheet" href="<?php echo base_url('assets/css/main.min.css?version=beta-3.5.10') ?>"/>
	<script type="text/javascript" src="<?php echo base_url('assets/js/min/head.bundle.js?version=beta-3.5.15') ?>"></script>
